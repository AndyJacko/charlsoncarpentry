...
<?php
if ($_POST["test_desc"] != "") {
	add("INSERT INTO tbl_testimonials (test_desc, test_who, test_date) VALUES ('".$_POST["test_desc"]."', '".$_POST["test_who"]."', '".$_POST["test_date"]."')");
  header("Location: /cp/testimonials.php?s=1");
}
?>
<!doctype html>
...
<div id="maincontainer">
  <div id="designcontainer">
    ...
    <p class="aligncenter">Add the details as required. Click "Add" to save the changes.</p>
    <br><br>
    <div class="cpform cpformstyle">
      ...
      <input name="test_who" type="text" id="test_who" value="">
      ...
      <input name="test_date" type="text" id="test_date" value="" placeholder="YYYY-MM-DD">
      
      <label>Testimonial<span class="small">Guests testimonial comments.</span></label>
      <textarea name="test_desc" cols="38" rows="5" id="test_desc"></textarea>
